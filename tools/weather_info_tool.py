...
def main():
    ...
    get_current_weather = weather_tool.weather_tool_list[0]
    get_weather_forecast = weather_tool.weather_tool_list[1]

    city = "Paris"

    print("== Current Weather ==")
    try:
        print(get_current_weather.run({"city": city}))
    except Exception as e:
        print(f"Error in current weather: {e}")

    print("\n== Weather Forecast ==")
    try:
        print(get_weather_forecast.run({"city": city}))
    except Exception as e:
